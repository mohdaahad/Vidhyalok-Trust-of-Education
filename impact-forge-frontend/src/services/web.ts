...
export const API_ENDPOINTS = {
    ...
    PROJECTS: {
        ...
        UPDATE_UPDATE: (id: number | string, updateId: number | string) => `/projects/${id}/updates/${updateId}`,
        DELETE_UPDATE: (id: number | string, updateId: number | string) => `/projects/${id}/updates/${updateId}`,
    ...
    EVENTS: {
        ...
        UPDATE_AGENDA: (id: number | string, agendaId: number | string) => `/events/${id}/agenda/${agendaId}`,
